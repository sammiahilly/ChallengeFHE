...
export class FhevmReactError extends Error { code: string; constructor(code: string, message?: string, options?: { cause?: unknown }) { super(message); if (options && "cause" in options) { (this as any).cause = options.cause; } this.code = code; this.name = "FhevmReactError"; } }
